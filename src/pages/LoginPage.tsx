        ...
        <div className="bg-white dark:bg-slate-900 py-8 px-6 shadow-xl rounded-3xl sm:px-10 border border-slate-200/80 dark:border-slate-800 space-y-6">
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <button
              ...
              className="w-full mt-2 flex items-center justify-center gap-2 py-2.5 px-4 rounded-xl shadow-md text-sm font-semibold text-white bg-sky-500 hover:bg-sky-600 focus:outline-hidden focus:ring-2 focus:ring-offset-2 focus:ring-sky-500 transition-all disabled:opacity-50"
            >
